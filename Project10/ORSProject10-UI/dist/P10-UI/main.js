...
var HttpServiceService = /** @class */ (function () {
    ...
    HttpServiceService.prototype.isLogout = function () {
        ...
        if ((JSESSIONID == "null" || JSESSIONID === null) && (this.router.url != "/login"
            ...
            console.log("Kartik Vijayvargiya");
            return true;
        }
        else {
            return false;
